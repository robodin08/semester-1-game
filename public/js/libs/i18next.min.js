!(function (e, t) {
  ...
  const u = (t) => (e(t) ? t.replace(/[&<>"'\/]/g, (e) => p[e]) : t);
  const g = [" ", ",", "?", "!", ";"],
    d = new (class {
      constructor(e) {
        ((this.capacity = e),
  ...
  class R extends b {
    ...
    translate(t, s, i) {
      ...
      const f = g?.usedKey || r,
        ...
        k = v ? this.pluralResolver.getSuffix(p, o.count, o) : "",
        S =
          o.ordinal && v
            ? this.pluralResolver.getSuffix(p, o.count, { ordinal: !1 })
            : "",
          ...
          ((d = this.extendTranslation(d, t, o, g, i)),
            ...
            (s || e) &&
              ...
              (d = this.options.parseMissingKeyHandler(
                this.options.appendNamespaceToMissingKey ? `${h}${c}${r}` : r,
                e ? d : void 0,
                o,
              )));
        }
            ...
            this.isValidLookup(i) ||
              ...
              d.forEach((t) => {
                ...
                if (this.i18nFormat?.addLookupKeys)
                  ...
                  let e;
                  p && (e = this.pluralResolver.getSuffix(t, s.count, s));
  ...
  class V {
    ...
    init(e = {}) {
      ...
      ((this.escape = void 0 !== t ? t : u),
        ...
        (this.unescapePrefix = h ? "" : p || "-"),
        (this.unescapeSuffix = this.unescapePrefix ? "" : h || ""),
        (this.nestingPrefix = g ? c(g) : d || c("$t(")),
        (this.nestingSuffix = f ? c(f) : m || c(")")),
  ...
  class D {
    ...
    init(e, t = { interpolation: {} }) {
      ...
      const s = t.cacheInBuiltFormats ? I : T;
      this.formats = {
        number: s((e, t) => {
  ...
  class H extends b {
    ...
    dir(e) {
      ...
      const t = this.services?.languageUtils || new C(A());
  ...
  return ((B.createInstance = H.createInstance), (B.keyFromSelector = L), B);
});
