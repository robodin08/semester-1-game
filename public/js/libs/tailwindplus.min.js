...
function $n(e) {
  return (e.getAnimations?.() ?? []).some(
    (e) => e instanceof CSSTransition && "finished" !== e.playState,
  );
}
...
function ct(e) {
  return e.replace(/start|end/g, (e) => Kn[e]);
}
var Fo = ["left", "right"],
  qo = ["right", "left"],
  jn = ["top", "bottom"],
...
function _e(e) {
  return e.replace(/left|right|bottom|top/g, (e) => _n[e]);
}
function Yn(e) {
...
var Qn = new Set(["inline", "contents"]);
function Ce(e) {
  let { overflow: t, overflowX: n, overflowY: o, display: r } = V(e);
  return /auto|scroll|overlay|hidden|clip/.test(t + o + n) && !Qn.has(r);
}
var Xn = new Set(["table", "td", "th"]);
function Qo(e) {
  return Xn.has(we(e));
}
...
function mt(e) {
  let t = ht(),
    n = q(e) ? V(e) : e;
  return (
    Zn.some((e) => !!n[e] && "none" !== n[e]) ||
    (!!n.containerType && "normal" !== n.containerType) ||
    (!t && !!n.backdropFilter && "none" !== n.backdropFilter) ||
    (!t && !!n.filter && "none" !== n.filter) ||
    er.some((e) => (n.willChange || "").includes(e)) ||
    tr.some((e) => (n.contain || "").includes(e))
  );
}
function Xo(e) {
  let t = Z(e);
...
var or = new Set(["html", "body", "#document"]);
function ye(e) {
  return or.has(we(e));
}
function V(e) {
...
function Zo(e, t, n) {
  let o;
  if ("viewport" === t) o = ar(e, n);
  else if ("document" === t) o = lr(_(e));
  else if (q(t)) o = cr(t, n);
  else {
    let n = on(e);
  ...
  for (; q(a) && !ye(a); ) {
    ...
    (!n && "fixed" === t.position && (r = null),
      (
        i
          ? !n && !r
          : (!n && "static" === t.position && r && ur.has(r.position)) ||
            (Ce(a) && !n && rn(e, a))
      )
        ? (o = o.filter((e) => e !== a))
        : (r = t),
